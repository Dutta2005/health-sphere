...
const CampaignCard = ({ title, description, icon: Icon, category, date, location }: any) => (
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <span className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 backdrop-blur-sm">
            <span className="text-sm font-medium text-primary">BloodBridge Network</span>
          </span>
            ...
            >
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-light-text/80 dark:text-dark-text/80">{label}</p>
                </div>
              </div>
            </Card>
          ))}
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-xl text-light-text/80 dark:text-dark-text/70 max-w-2xl mx-auto">
            Share your thoughts and experiences with other blood donors. Your story could inspire someone to save a life.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-light-text/70 dark:text-dark-text/70">
            Connect with organizations and participate in campaigns that make a real difference 
            in your community's healthcare.
          </p>
        </div>
